...
namespace ExtService.GateWay.DBContext.Migrations
{
    ...
    [Migration("20240827150043_InitialCreate")]
            ...
            modelBuilder.Entity("ExtService.GateWay.DBContext.DBModels.Billing", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_RequestCount_GTE_Zero", "\"RequestCount\" >= 0");

                    b.HasCheckConstraint("CK_RequestLimit_Greater_Than_Zero", "\"RequestLimit\" > 0");

                    b.HasCheckConstraint("CK_StartDate_Less_Than_EndDate", "\"StartDate\" < \"EndDate\"");
                });
            ...
            modelBuilder.Entity("ExtService.GateWay.DBContext.DBModels.BillingConfig", b =>
                {
                    ...
                    b.ToTable("BillingConfig");

                    b.HasCheckConstraint("CK_PeriodInDays_Greater_Than_Zero", "\"PeriodInDays\" > 0");

                    b.HasCheckConstraint("CK_RequestLimitPerPeriod_Greater_Than_Zero", "\"RequestLimitPerPeriod\" > 0");
            ...
            modelBuilder.Entity("ExtService.GateWay.DBContext.DBModels.NotificationInfo", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_NotificationLimitPercentage_Range", "\"NotificationLimitPercentage\" > 0 AND \"NotificationLimitPercentage\" < 100");
                });
