...
namespace ExtService.GateWay.DBContext.Migrations
{
    ...
    [Migration("20241125140413_FunctionsAndTriggersExtensionMigration")]
    partial class FunctionsAndTriggersExtensionMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExtService.GateWay.DBContext.DBModels.PluginLinks", b =>
                {
                    ...
                    b.HasIndex("MethodHeaderId");

                    b.HasIndex("ParameterId");

                    b.HasIndex("PluginId");

                    b.ToTable("PluginLinks");
                });

            modelBuilder.Entity("ExtService.GateWay.DBContext.DBModels.PluginParameters", b =>
                {
                    b.Property<Guid>("ParameterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ExtService.GateWay.DBContext.DBModels.Plugins", b =>
                {
                    b.Property<Guid>("PluginId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ExtService.GateWay.DBContext.DBModels.TransactionLog", b =>
                {
            ...
            modelBuilder.Entity("ExtService.GateWay.DBContext.DBModels.MethodHeaders", b =>
                {
                    ...
                    b.HasOne("ExtService.GateWay.DBContext.DBModels.Plugins", "Plugin")
                        .WithMany("MethodHeaders")
            ...
            modelBuilder.Entity("ExtService.GateWay.DBContext.DBModels.PluginLinks", b =>
                {
                    b.HasOne("ExtService.GateWay.DBContext.DBModels.MethodHeaders", "MethodHeader")
                        .WithMany("PluginLinks")
                        .HasForeignKey("MethodHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ExtService.GateWay.DBContext.DBModels.PluginParameters", "Parameter")
                        .WithMany("PluginLinks")
